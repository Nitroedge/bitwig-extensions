package dev.bcrick.bitwigpal.handlers;
...
import dev.bcrick.bitwigpal.extension.BitwigPalExtension;
import dev.bcrick.bitwigpal.extension.StateCache;
import dev.bcrick.bitwigpal.rpc.JsonRpcDispatcher;

import static dev.bcrick.bitwigpal.rpc.JsonParamValidator.*;
...
public class ArrangerClipHandler {
    ...
    private static final int GRID_WIDTH = BitwigPalExtension.CLIP_GRID_WIDTH;
    private static final int GRID_HEIGHT = BitwigPalExtension.CLIP_GRID_HEIGHT;
