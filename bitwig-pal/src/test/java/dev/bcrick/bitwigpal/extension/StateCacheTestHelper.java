...
public class StateCacheTestHelper {
     ...
     *
     * <p>Both {@link BitwigPalExtension} and {@link StateCache} declare their own
     ...
     * {@link BitwigPalExtension}, {@link StateCache}, and the {@code SceneHandler},
     * {@code ClipHandler} and {@code TrackHandler} in {@code dev.bcrick.bitwigpal.handlers}.
     ...
     * tests in {@code dev.bcrick.bitwigpal.handlers} need it too: their out-of-range cases must
     ...
     *
     * <p>Three classes in {@code dev.bcrick.bitwigpal.handlers} declare their own
     ...
     * {@code dev.bcrick.bitwigpal.extension} read three declarations that live in another package.
     *
