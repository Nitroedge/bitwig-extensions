...
import static dev.bcrick.bitwigpal.extension.StateCacheTestHelper.trackCountOf;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Guards the track ceiling, which is carried by two independent constants.
 *
 * <p>{@code TRACK_COUNT} is declared separately in {@link BitwigPalExtension} (it sizes the
 ...
 * {@code dev.bcrick.bitwigpal.extension} for that reason.
 */
class TrackCountConsistencyTest {
    ...
    void trackCount_agreesBetweenExtensionAndStateCache() {
        assertEquals(
            trackCountOf(BitwigPalExtension.class),
            trackCountOf(StateCache.class),
            "TRACK_COUNT disagrees between "
                + "src/main/java/dev/bcrick/bitwigpal/extension/BitwigPalExtension.java and "
                + "src/main/java/dev/bcrick/bitwigpal/extension/StateCache.java. "
