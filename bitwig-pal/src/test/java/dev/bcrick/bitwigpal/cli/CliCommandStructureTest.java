...
class CliCommandStructureTest {
    ...
    void songCommandRegisteredInCli() {
        CommandLine cli = new CommandLine(new BitwigPalCli());
        assertNotNull(cli.getSubcommands().get("song"),
            "BitwigPalCli should have 'song' subcommand");
    }
    ...
    void cliHasTwelveSubcommands() {
        ...
        assertEquals(12, cli.getSubcommands().size(),
            "BitwigPalCli should have 12 subcommands");
    }
    ...
    void snapshotIsRegistered() {
        ...
        assertNotNull(cli.getSubcommands().get("snapshot"),
            "BitwigPalCli should have 'snapshot' subcommand");
    }
    ...
    void rpcIsRegistered() {
        ...
        assertNotNull(cli.getSubcommands().get("rpc"),
            "BitwigPalCli should have 'rpc' subcommand");
    }
    ...
    void sceneHas7Subcommands() {
        ...
        assertNotNull(scene, "BitwigPalCli should have 'scene' subcommand");
    ...
    void actionHas3Subcommands() {
        ...
        assertNotNull(action, "BitwigPalCli should have 'action' subcommand");
    ...
    void mixerHas4Subcommands() {
        ...
        assertNotNull(mixer, "BitwigPalCli should have 'mixer' subcommand");
    ...
    void projectHas6Subcommands() {
        ...
        assertNotNull(project, "BitwigPalCli should have 'project' subcommand");
    ...
    void watchIsRegistered() {
        ...
        assertNotNull(cli.getSubcommands().get("watch"),
            "BitwigPalCli should have 'watch' subcommand");
    }
