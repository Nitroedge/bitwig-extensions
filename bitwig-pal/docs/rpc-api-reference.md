# Bitwig Pal RPC API Reference

Complete reference for all JSON-RPC methods exposed by the Bitwig Pal Bitwig Studio controller extension.
...
Bitwig Pal uses **JSON-RPC 2.0** over HTTP for synchronous request/response communication, and WebSocket for real-time state streaming.
