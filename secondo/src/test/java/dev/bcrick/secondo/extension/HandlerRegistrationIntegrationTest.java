...
import dev.bcrick.secondo.handlers.*;
...
class HandlerRegistrationIntegrationTest {
    ...
    void setUp() throws IOException {
        ...
        // Register built-in methods (mirrors SecondoExtension.init)
        ...
        // Register every handler in the same order as SecondoExtension.init(). This mirror is
