...
class HttpRpcServerTest {
    ...
    void healthEndpointReturnsOk() throws Exception {
        ...
        // moving SecondoVersion.VERSION alone would have failed here and read as a regression,
        ...
        assertTrue(
            response.body().contains("\"version\":\"" + SecondoVersion.VERSION + "\""),
            "/health must report SecondoVersion.VERSION (" + SecondoVersion.VERSION
    ...
    private String rawPost(String path, String hostHeader, String originHeader, String body)
        ...
        try (java.net.Socket socket = new java.net.Socket("127.0.0.1", TEST_PORT)) {
            ...
            try {
                ...
                // Measured cause on the secondo validation machine, 2026-09-09: a machine-local
    ...
    void refusesARpcPostWhoseHostIsNotLoopback() throws Exception {
        ...
        // 2026-09-09, when it began failing on the secondo validation machine with
        ...
        // secondo's own `tests/test_transport_http.py` sends, so the two repositories now
