...
#
# Prerequisites: Bitwig running, secondo extension loaded.
#
...
echo ""
echo "Prerequisites: Bitwig running with secondo loaded."
echo ""
...
verify \
  "Show notification" \
  "Do you see a notification popup in Bitwig saying 'Hello from secondo'?" \
  '{"jsonrpc":"2.0","method":"app/showNotification","params":{"text":"Hello from secondo"},"id":606}'
